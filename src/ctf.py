    ...
    for service in services:
        ...
        if service_product and service_version:
            ...
            if cves:
                ...
                print(f"[-] No CVEs found for {service_product} {service_version}")
            ...
            if exploits:
                ...
                print(f"[-] No exploits found for {service_product} {service_version}")
        else:
            print(f"[-] No version information for {service_name} on port {port}")